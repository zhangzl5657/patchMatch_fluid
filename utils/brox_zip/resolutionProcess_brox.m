function [du, dv] = resolutionProcess_brox(Ikz, Ikx, Iky, Ixz, Iyz, alpha, gamma, omega, uinit, vinit, outer_iter, inner_iter,alphaImg) 
...
for i = 1 : outer_iter
	...
	psidashFS = computePsidashFS_brox( u + du, v + dv, alphaImg ) ;
